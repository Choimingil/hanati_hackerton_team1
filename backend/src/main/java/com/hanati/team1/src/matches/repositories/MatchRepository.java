...
public interface MatchRepository extends JpaRepository<Match,Long> {
	@Query("select new com.hanati.team1.src.matches.models.GetMatchListRes(m.matchId, m.matchDate, m.playerStatus, m.playerPlaytime, m.playerScore, m.playerYcardNum) "
		+ "from Match m "
